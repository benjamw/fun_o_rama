	...
	*/
	public function input($fieldName, $options = array()) {
		$defaults = array(
			...
			'class'		=> 'form-control', // @todo make this dynamic
			'div'		=> array(
				'class' => 'form-group'
			),
			'error'		=> array(
		...
		if ((isset($options['type']) && (('radio' === $options['type']) || ('checkbox' === $options['type']))) || (isset($options['multiple']) && ('checkbox' === $options['multiple']))) {
			$defaults['between'] = $defaults['after'] = '';
			$defaults['div']['class'] = '';
			$defaults['class'] = '';
		}
