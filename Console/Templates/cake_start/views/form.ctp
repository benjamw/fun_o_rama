...
<div class="<?php echo $pluralVar; ?> form">
	<?php echo "<?php echo \$this->Form->create('{$modelClass}', array('action' => \$this->action{$file_type})); ?>\n"; ?>
		<fieldset>
...
<?php if (strpos($action, 'add') === false) { ?>
		...
		<li><?php echo "<?php echo \$this->Form->postLink(__('Delete'), array('action' => 'delete', \$this->Form->value('{$modelClass}.{$primaryKey}')), null, __('Are you sure you want to delete {$singularHumanName} #%s?', \$this->Form->value('{$modelClass}.{$primaryKey}'))); ?>"; ?></li>
		<?php echo "<?php } ?>\n"; ?>
<?php } ?>
